...
在[这里](https://github.com/ConCopilot/concopilot/concopilot_examples)查看范例代码和配置。
...
1. 下载这个简化版的类Auto-GPT[副官范例](https://github.com/ConCopilot/concopilot/concopilot_examples/config.yaml)。
2. 执行以下命令运行:
